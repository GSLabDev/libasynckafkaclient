...
inline Int8 ReadInt8(std::stringstream& is)
{
  Int8 result = 0;
...
inline Int16 ReadInt16(std::stringstream& is)
{
  Int16 result = 0;
...
inline Int32 ReadInt32(std::stringstream& is)
{
  Int32 result = 0;
...
inline Int64 ReadInt64(std::stringstream& is)
{
  Int64 result = 0;
...
inline String ReadString(std::stringstream& is)
{
...
inline void ReadBytes(std::stringstream& is, Bytes& bytes)
{
...
inline void ReadMessage(std::stringstream& is, Message& message)
{
...
inline void ReadMessageSet(std::stringstream& is,
